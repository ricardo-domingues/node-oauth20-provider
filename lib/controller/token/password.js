...
module.exports = function(oauth2, client, username, password, scope, headers, pCb) {
    ...
    async.waterfall([
        ...
        function(cb) {
            oauth2.model.accessToken.create(oauth2.model.user.getId(user), oauth2.model.client.getId(client), scope, oauth2.model.accessToken.ttl, headers, function(err, data) {
                if (err)
